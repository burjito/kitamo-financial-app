  ...
  return (
    <div className="w-full max-w-md space-y-6">
      <div className="text-center space-y-4">
        ...
        <div>
          <h1 className="text-4xl font-bold bg-gradient-primary bg-clip-text text-transparent">KitaMo</h1>
          <p className="text-muted-foreground">Your Financial Flight Simulator</p>
        </div>
      </div>

      <Card className="border-0 shadow-app-card bg-card/80 backdrop-blur-sm">
        ...
        <CardContent className="space-y-4">
          ...
          <div className="grid grid-cols-2 gap-4">
            <Button variant="outline" className="app-button-outline">
